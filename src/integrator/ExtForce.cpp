...
ExtForce::ExtForce(std::shared_ptr<System> system,
...
void ExtForce::disconnect() { _aftInitF.disconnect(); }
...
void ExtForce::setExtForce(Real3D& _extForce) { extForce = _extForce; }

Real3D& ExtForce::getExtForce() { return extForce; }
