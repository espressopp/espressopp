...
FixPositions::FixPositions(std::shared_ptr<System> system,
...
std::shared_ptr<ParticleGroup> FixPositions::getParticleGroup() { return particleGroup; }

void FixPositions::setFixMask(Int3D& _fixMask) { fixMask = _fixMask; }

Int3D& FixPositions::getFixMask() { return fixMask; }
...
void FixPositions::registerPython()
{
    ...
    class_<FixPositions, std::shared_ptr<FixPositions>, bases<Extension> >
        ...
        ("integrator_FixPositions",
         init<std::shared_ptr<System>, std::shared_ptr<ParticleGroup>, const Int3D&>())
            .add_property("particleGroup", &FixPositions::getParticleGroup,
                          &FixPositions::setParticleGroup)
            .def("getFixMask", &FixPositions::getFixMask,
