...
void LangevinThermostat1D::frictionThermo(Particle& p) {
  ...
  p.force()[direction] +=
      pref1 * p.velocity()[direction] * p.mass() + pref2 * ranval * massf;
...
void LangevinThermostat1D::registerPython() {
  ...
  class_<LangevinThermostat1D, shared_ptr<LangevinThermostat1D>,
         bases<Extension> >("integrator_LangevinThermostat1D",
                            init<shared_ptr<System> >())
      .def("connect", &LangevinThermostat1D::connect)
      .def("disconnect", &LangevinThermostat1D::disconnect)
      .add_property("adress", &LangevinThermostat1D::getAdress,
                    &LangevinThermostat1D::setAdress)
      .add_property("gamma", &LangevinThermostat1D::getGamma,
                    &LangevinThermostat1D::setGamma)
