...
public:
    VerletListLennardJones(std::shared_ptr<VerletList> _verletList) : verletList(_verletList)
    {
    ...
    {
        if (type1 >= int_c(potentialArray.size_n()) || type2 >= int_c(potentialArray.size_m()))
