...
void NodeGrid::calcNodeNeighbors(longint node)
{
    ...
    LOG4ESPP_DEBUG(logger, "my position: " << node << " -> " << nodePos[0] << " " << nodePos[1]
                                           << " " << nodePos[2]);
    ...
    for (int dir = 0; dir < 3; ++dir)
    {
        ...
        LOG4ESPP_DEBUG(logger, "left neighbor in dir "
        ...
        LOG4ESPP_DEBUG(logger, "right neighbor in dir "
        ...
        LOG4ESPP_DEBUG(logger, "boundaries in dir " << dir << ": " << getBoundary(2 * dir) << " "
                                                    << getBoundary(2 * dir + 1));
    }
}
