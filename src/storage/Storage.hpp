...
public:
    ...
    */
    ...
    boost::signals2::signal<void(ParticleList&, class OutBuffer&)> beforeSendParticles;
    boost::signals2::signal<void(ParticleList&, class InBuffer&)> afterRecvParticles;
...
public:
    ...
    void addParticlesFromArrayImpl(const real* part,
                                   const int* idx,
                                   const int npart,
                                   const int nidx);
    /////////////////////////////////////////////////////////////////////////
