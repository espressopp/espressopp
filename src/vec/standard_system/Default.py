...
r"""
**********************************
espressopp.vec.standard_system.Default
**********************************


.. py:method:: espressopp.vec.standard_system.Default(box, rc = 1.12246, skin = 0.3, dt = 0.005, temperature = None)
                ...
                Return default system, integrator and vectorization context, no interactions, no particles are set
