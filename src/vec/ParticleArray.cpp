...
/////////////////////////////////////////////////////////////////////////////////////////////////
void ParticleArray::markRealCells(CellList const& realcellsIn,
                                  const Cell* cell0,
...
/////////////////////////////////////////////////////////////////////////////////////////////////
void ParticleArray::markRealCells(std::vector<size_t> const& realcellsIn, size_t numLocalCells)
{
...
void ParticleArray::markGhostCells()
{
    ...
    for (auto const rc : realCells_) cells[rc]++;
...
void ParticleArray::updateFromPositionVelocity(CellList const& srcCells, bool realOnly)
{
    ...
    if (realOnly)
    {
        auto updateRealCell = [this, &updateCell](size_t ir) { updateCell(realCells_.at(ir)); };
