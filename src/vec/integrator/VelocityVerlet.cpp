...
VelocityVerletBase::VelocityVerletBase(std::shared_ptr<System> system) : MDIntegratorVec(system)
{
...
void VelocityVerletBase::initForcesParray() { getSystem()->vectorization->zeroForces(); }
...
int VelocityVerletBase::getNumResorts() const { return nResorts; }
...
void VelocityVerletBase::registerPython()
{
    ...
    class_<vec::integrator::VelocityVerletBase,
           bases<espressopp::integrator::MDIntegrator, MDIntegratorVec>, boost::noncopyable>(
...
void VelocityVerlet::registerPython()
{
    ...
    class_<vec::integrator::VelocityVerlet, bases<VelocityVerletBase>, boost::noncopyable>(
