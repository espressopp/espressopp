    ...
    : globalTriples()
{
    ...
    sigBeforeSend = storage->beforeSendParticles.connect(std::bind(
        &FixedTripleList::beforeSendParticles, this, std::placeholders::_1, std::placeholders::_2));
    sigAfterRecv = storage->afterRecvParticles.connect(std::bind(
        &FixedTripleList::afterRecvParticles, this, std::placeholders::_1, std::placeholders::_2));
    sigOnParticlesChanged =
        storage->onParticlesChanged.connect(std::bind(&FixedTripleList::onParticlesChanged, this));
}
...
bool FixedTripleList::add(size_t pid1, size_t pid2, size_t pid3)
{
    bool returnVal = true;
    ...
    if (returnVal)
    {
        ...
        else
        {
            ...
            globalTriples.insert(equalRange.first,
                                 std::make_pair(pid2, std::pair<size_t, size_t>(pid1, pid3)));
        }
...
void FixedTripleList::registerPython()
{
    ...
    bool (FixedTripleList::*pyAdd)(size_t pid1, size_t pid2, size_t pid3) = &FixedTripleList::add;
