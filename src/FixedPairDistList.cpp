    ...
    : storage(_storage), pairsDist()
{
    ...
    con1 = storage->beforeSendParticles.connect(std::bind(&FixedPairDistList::beforeSendParticles,
                                                          this, std::placeholders::_1,
                                                          std::placeholders::_2));
    con2 = storage->afterRecvParticles.connect(std::bind(&FixedPairDistList::afterRecvParticles,
                                                         this, std::placeholders::_1,
                                                         std::placeholders::_2));
...
bool FixedPairDistList::add(longint pid1, longint pid2)
{
    bool returnVal = true;
...
void FixedPairDistList::beforeSendParticles(ParticleList& pl, OutBuffer& buf)
{
...
void FixedPairDistList::afterRecvParticles(ParticleList& pl, InBuffer& buf)
{
...
void FixedPairDistList::onParticlesChanged()
{
