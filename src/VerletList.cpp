...
/*-------------------------------------------------------------*/
  ...
  // add particles to adress zone
  void VerletList::isPairInAdrZone(Particle& pt1, Particle& pt2) {
  ...
  void VerletList::addAtParticle(longint pid) {
        atmList.insert(pid);
  }
  ...
  ****************************************************/
  ...
  void VerletList::registerPython() {
    ...
    void (VerletList::*pyAddAtParticle)(longint pid)
          = &VerletList::addAtParticle;
