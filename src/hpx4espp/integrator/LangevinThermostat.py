...
r"""
*************************************************
espressopp.hpx4espp.integrator.LangevinThermostat
*************************************************
...
>>> langevin = espressopp.hpx4espp.integrator.LangevinThermostat(system)
...
.. function:: espressopp.hpx4espp.integrator.LangevinThermostat(system)

        :param system: system object
        :type system: shared_ptr<System>

.. function:: espressopp.hpx4espp.integrator.LangevinThermostat.addExclusions(pidlist)
...
from espressopp.hpx4espp.integrator.Extension import *
from _espressopp import hpx4espp_integrator_LangevinThermostat

class LangevinThermostatLocal(ExtensionLocal, hpx4espp_integrator_LangevinThermostat):

    def __init__(self, system):
        if not (pmi._PMIComm and pmi._PMIComm.isActive()) or pmi._MPIcomm.rank in pmi._PMIComm.getMPIcpugroup():
            cxxinit(self, hpx4espp_integrator_LangevinThermostat, system, system.storage)
...
if pmi.isController :
    class LangevinThermostat(Extension, metaclass=pmi.Proxy):
        pmiproxydefs = dict(
            cls =  'espressopp.hpx4espp.integrator.LangevinThermostatLocal',
