...
#define CHECK_TRUE_1(X)                                                                   \
    {                                                                                     \
        ...
        {                                                                                 \
            if (!((X)))                                                                   \
            {                                                                             \
                LOG(espressopp::generateAssertionMessage((X), #X, "", __FILE__, __LINE__, \
                                                         __func__));                      \
                exit(EXIT_FAILURE);                                                       \
            }                                                                             \
        } while (0);                                                                      \
...
#define CHECK_NULLPTR_1(X)                                                                 \
    {                                                                                      \
        ...
        {                                                                                  \
            if (!((X) == nullptr))                                                         \
            {                                                                              \
                LOG(espressopp::generateAssertionMessage((X), #X, "nullptr == ", __FILE__, \
                                                         __LINE__, __func__));             \
                exit(EXIT_FAILURE);                                                        \
            }                                                                              \
        } while (0);                                                                       \
...
#define CHECK_EQUAL_2(X, Y)                                                                  \
    {                                                                                        \
        ...
        {                                                                                    \
            if (!((X) == (Y)))                                                               \
            {                                                                                \
                LOG(espressopp::generateAssertionMessage((X), (Y), #X, #Y, " == ", __FILE__, \
                                                         __LINE__, __func__));               \
                exit(EXIT_FAILURE);                                                          \
            }                                                                                \
        } while (0);                                                                         \
