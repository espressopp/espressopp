...
class VerletListSmoothSquareWellLocal(
        InteractionLocal,
...
class FixedPairListSmoothSquareWellLocal(
        InteractionLocal,
...
class FixedPairListTypesSmoothSquareWellLocal(
        InteractionLocal,
