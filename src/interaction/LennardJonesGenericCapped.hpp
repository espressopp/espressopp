...
// ESPP_CLASS
#ifndef _INTERACTION_LENNARDJONESGENERICAPPED
#define _INTERACTION_LENNARDJONESGENERICCAPPED_HPP
...
namespace espressopp {
  namespace interaction {
    ...
    */
    class LennardJonesGenericCapped : public PotentialTemplate< LennardJonesGenericCapped > {
    private:
      real epsilon;
      real sigma;
      real caprad;
	...
	: epsilon(0.0), sigma(0.0), a(0), b(0) {
      ...
      LennardJonesGenericCapped(real _epsilon, real _sigma, int _a, int _b,
		   real _cutoff, real _caprad)
	: epsilon(_epsilon), sigma(_sigma), a(_a), b(_b), caprad(_caprad) {
	...
	: epsilon(_epsilon), sigma(_sigma), a(_a), b(_b) {
      ...
      virtual ~LennardJonesGenericCapped() {};
    ...
    struct LennardJonesGenericCapped_pickle : boost::python::pickle_suite
    {
      static
      boost::python::tuple
      getinitargs(LennardJonesGenericCapped const& pot)
      {
    	  real eps;
          real sig;
          int a;
          ...
          a  =pot.getA();
          b  =pot.getB();
          return boost::python::make_tuple(eps, sig, a, b, rc, cr, sh);
      }
    };
  }
}
