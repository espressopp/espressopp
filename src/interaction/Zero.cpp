...
//////////////////////////////////////////////////
void Zero::registerPython() {
  using namespace espressopp::python;

  class_<Zero, bases<Potential> >("interaction_Zero", init<>())
      .def(init<>())
      .def_pickle(Zero_pickle());

  class_<VerletListZero, bases<Interaction> >("interaction_VerletListZero",
                                              init<shared_ptr<VerletList> >())
      .def("setPotential", &VerletListZero::setPotential,
           return_value_policy<reference_existing_object>())
      .def("getPotential", &VerletListZero::getPotential,
           return_value_policy<reference_existing_object>());
