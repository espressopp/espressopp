...
namespace espressopp {
  namespace interaction {
    ...
    CoulombScafacos::CoulombScafacos(shared_ptr< System > _system, real _prefactor, real _tolerance, int _ntotal, const char* _method){
      system = _system;
    ...
    void CoulombScafacos::registerPython() {
      ...
      class_< CellListCoulombScafacos, bases< Interaction > >
        ("interaction_CellListCoulombScafacos",	init< shared_ptr< storage::Storage >, shared_ptr< CoulombScafacos > >())
