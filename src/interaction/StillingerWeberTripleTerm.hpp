...
public:
    ...
    StillingerWeberTripleTerm(real _gamma1,
                              real _gamma2,
                              real _theta0,
                              real _lambda,
                              real _epsilon,
                          ...
                          const Real3D& r32) const
    {
        ...
        else
        {
            ...
            real expProduct =
                epsilonLambda * exp(sigmaGamma1 * inv_d12_a + sigmaGamma2 * inv_d32_a);
            ...
            force12 = factor1 * e12 * inv_d12_a2 - expTerm * (e32 - e12 * cosTeta123) * inv_d12;

            force32 = factor2 * e32 * inv_d32_a2 - expTerm * (e12 - e32 * cosTeta123) * inv_d32;
            return true;
        }
    }
    ...
    {
        std::cout << "Function _computeEnergyRaw doesn't work in StillingerWeberTripleTerm"
                  << std::endl;
        real energy = 0.0;
        return energy;
    }
    ...
    {
        std::cout << "Function _computeForceRaw(teta) doesn't work in StillingerWeberTripleTerm"
                  << std::endl;
        return 0.0;
    }
};
