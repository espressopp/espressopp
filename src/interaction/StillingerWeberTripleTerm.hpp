    ...
    public:
      ...
      void _computeForceRaw(Real3D& force12, Real3D& force32,
        ...
        if (d12 >= getCutoff() || d32 >= getCutoff() ){
          ...
          real pref1 = - gamma * _computeEnergy(r21, r23);
          ...
          real cosTeta123 = (r21 * r23) / (d12 * d32);
          real cosTeta0 = -1/3.;
          real difCos = cosTeta123 - cosTeta0;

          // 2 is the main particle
          force12 = ( pref1 * r21/d12 * inv_d12_a2 +
                  2*lambda* exp( gamma*inv_d12_a) * exp(gamma*inv_d32_a) * difCos *
                  ( r23/d32/d12 - r21/d12/d12 * cosTeta123) );

          force32 = ( pref1 * r23/d32 * inv_d32_a2 +
                  2*lambda* exp( gamma*inv_d12_a) * exp(gamma*inv_d32_a) * difCos *
                  ( r21/d12/d32 - r23/d32/d32 * cosTeta123) );

  //std::cout<<"In force loop. F1:"<< force12 << "  F2: "<< force32 <<std::endl;
