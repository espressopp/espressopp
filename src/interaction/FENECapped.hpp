...
public:
    ...
    FENECapped() : K(0.0), r0(0.0), rMax(0.0), r_cap(0.0)
    {
        setShift(0.0);
        setCutoff(infinity);
    }

    FENECapped(real _K, real _r0, real _rMax, real _cutoff, real _r_cap, real _shift)
    ...
    FENECapped(real _K, real _r0, real _rMax, real _cutoff, real _r_cap)
        : K(_K), r0(_r0), rMax(_rMax), r_cap(_r_cap)
    {
        autoShift = false;
        setCutoff(_cutoff);
