...
public:
    ...
    virtual python::list computeForce(const Real3D& dist,
                                      const real& sigmai,
                                      const real& sigmaj) const = 0;
...
//////////////////////////////////////////////////
template <class Derived>
inline PotentialVSpherePairTemplate<Derived>::PotentialVSpherePairTemplate()
    : cutoff(infinity), cutoffSqr(infinity), shift(0.0), autoShift(false)
{
}

// Shift/cutoff handling
template <class Derived>
inline void PotentialVSpherePairTemplate<Derived>::setCutoff(real _cutoff)
{
    cutoff = _cutoff;
...
template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::getCutoff() const
{
    return cutoff;
}

template <class Derived>
inline void PotentialVSpherePairTemplate<Derived>::setShift(real _shift)
{
    autoShift = false;
    shift = _shift;
}
...
template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::getShift() const
{
    return shift;
}

template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::setAutoShift()
{
    autoShift = true;
...
template <class Derived>
inline void PotentialVSpherePairTemplate<Derived>::updateAutoShift()
{
...
// Energy computation
template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::computeEnergy(const Particle& p1,
                                                                 const Particle& p2) const
{
...
template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::computeEnergy(const Real3D& dist,
                                                                 real& sigmaij) const
{
...
template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::computeEnergy(real dist, real sigmaij) const
{
    return computeEnergySqr(dist * dist, sigmaij);
}

template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::computeEnergySqr(real distsqr,
                                                                    real sigmaij) const
{
...
template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::_computeEnergy(const Particle& p1,
                                                                  const Particle& p2) const
{
    Real3D dist = p1.position() - p2.position();
    real r1 = p1.radius();
...
template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::_computeEnergy(const Real3D& dist,
                                                                  real& sigmaij) const
{
...
template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::_computeEnergy(real dist, real sigmaij) const
{
    return _computeEnergySqr(dist * dist, sigmaij);
}

template <class Derived>
inline real PotentialVSpherePairTemplate<Derived>::_computeEnergySqr(real distSqr,
                                                                     real sigmaij) const
{
...
// Force computation
template <class Derived>
inline python::list PotentialVSpherePairTemplate<Derived>::computeForce(const Particle& p1,
                                                                        const Particle& p2) const
{
    Real3D fr;
    real fsi, fsj;
...
template <class Derived>
inline python::list PotentialVSpherePairTemplate<Derived>::computeForce(const Real3D& dist,
                                                                        const real& sigmai,
                                                                        const real& sigmaj) const
{
    Real3D fr;
...
template <class Derived>
inline bool PotentialVSpherePairTemplate<Derived>::_computeForce(
    Real3D& force, real& fsi, real& fsj, const Particle& p1, const Particle& p2) const
{
    Real3D dist = p1.position() - p2.position();
...
template <class Derived>
inline bool PotentialVSpherePairTemplate<Derived>::_computeForce(Real3D& force,
                                                                 real& fsi,
                                                                 real& fsj,
                                                                 const Real3D& dist,
                                                                 const real& sigmai,
