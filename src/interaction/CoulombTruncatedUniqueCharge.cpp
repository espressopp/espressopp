...
//////////////////////////////////////////////////
void CoulombTruncatedUniqueCharge::registerPython()
{
    ...
    class_<CoulombTruncatedUniqueCharge, bases<Potential> >(
        ...
        .add_property("qq", &CoulombTruncatedUniqueCharge::getQQ,
                      &CoulombTruncatedUniqueCharge::setQQ)
    ...
    class_<FixedPairListCoulombTruncatedUniqueCharge, bases<Interaction> >(
        ...
        init<std::shared_ptr<System>, std::shared_ptr<FixedPairList>,
             std::shared_ptr<CoulombTruncatedUniqueCharge> >())
