...
CoulombKSpaceP3M::CoulombKSpaceP3M(std::shared_ptr<System> _system,
      ...
      interpolation(_interpolation)
{
    ...
    */
    connectionRecalcKVec =
        system->bc->onBoxDimensionsChanged.connect(std::bind(&CoulombKSpaceP3M::preset, this));
    ...
    connectionGetParticleNumber = system->storage->onParticlesChanged.connect(
        std::bind(&CoulombKSpaceP3M::getParticleNumber, this));
...
void CoulombKSpaceP3M::registerPython()
{
    ...
    class_<CellListCoulombKSpaceP3M, bases<Interaction> >(
        ...
        init<std::shared_ptr<storage::Storage>, std::shared_ptr<CoulombKSpaceP3M> >())
