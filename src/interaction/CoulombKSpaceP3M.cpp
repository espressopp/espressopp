...
CoulombKSpaceP3M::CoulombKSpaceP3M(shared_ptr<System> _system, real _coulomb_prefactor, real _alpha,
  ...
  // This function calculates the square of all particle charges. It should be
  // called ones,
