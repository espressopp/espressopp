...
public:
    VerletListAdressCGInteractionTemplate(std::shared_ptr<VerletListAdress> _verletList,
...
//////////////////////////////////////////////////
template <typename _Potential>
inline void VerletListAdressCGInteractionTemplate<_Potential>::addForces()
{
...
template <typename _Potential>
inline real VerletListAdressCGInteractionTemplate<_Potential>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv in "
                 "VerletListAdressCGInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _Potential>
inline real VerletListAdressCGInteractionTemplate<_Potential>::computeEnergyAA()
{
    std::cout << "Warning! At the moment computeEnergyAA in VerletListAdressCGInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential>
inline real VerletListAdressCGInteractionTemplate<_Potential>::computeEnergyAA(int atomtype)
{
...
template <typename _Potential>
inline real VerletListAdressCGInteractionTemplate<_Potential>::computeEnergyCG()
{
    std::cout << "Warning! At the moment computeEnergyCG in VerletListAdressCGInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential>
inline real VerletListAdressCGInteractionTemplate<_Potential>::computeEnergyCG(int atomtype)
{
...
template <typename _Potential>
inline real VerletListAdressCGInteractionTemplate<_Potential>::computeVirial()
{
    LOG4ESPP_INFO(theLogger, "compute the virial for the Verlet List");
    std::cout << "Warning! At the moment computeVirial in VerletListAdressCGInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential>
inline real VerletListAdressCGInteractionTemplate<_Potential>::getMaxCutoff()
{
    real cutoff = 0.0;
