...
void AngularPotential::registerPython() {
  ...
  real (AngularPotential::*computeEnergy1)(const Real3D& dist12,
  ...
  void (AngularPotential::*computeForce1)(
      Real3D & force12, Real3D & force32, const Real3D& dist12,
      const Real3D& dist32) const = &AngularPotential::computeForce;

  real (AngularPotential::*computeForce2)(real theta) const =
      &AngularPotential::computeForce;

  class_<AngularPotential, boost::noncopyable>("interaction_AngularPotential",
                                               no_init)
      .add_property("cutoff", &AngularPotential::getCutoff,
