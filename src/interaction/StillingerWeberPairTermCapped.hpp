...
public:
    ...
    StillingerWeberPairTermCapped()
        : A(0.0), B(0.0), p(0.0), q(0.0), epsilon(0.0), sigma(0.0), caprad(0.0)
    {
        setShift(0.0);
        setCutoff(infinity);
        preset();
    ...
    StillingerWeberPairTermCapped(
        real _A, real _B, real _p, real _q, real _epsilon, real _sigma, real _cutoff, real _caprad)
