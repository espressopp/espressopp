...
public:
    FixedLocalTupleComListInteractionTemplate(std::shared_ptr<System> _system,
    ...
    void setCom(longint id, const Real3D& pos) { com_origin[id] = pos; }
...
//////////////////////////////////////////////////
template <typename _Potential>
inline void FixedLocalTupleComListInteractionTemplate<_Potential>::addForces()
{
    ...
    for (FixedLocalTupleList::TupleList::Iterator it(*fixedtupleList); it.isValid(); ++it)
    {
        ...
        bc.getMinimumImageVectorBox(diff, com_origin[pid / N_Constrain],
...
template <typename _Potential>
inline real FixedLocalTupleComListInteractionTemplate<_Potential>::computeEnergy()
{
...
template <typename _Potential>
inline real FixedLocalTupleComListInteractionTemplate<_Potential>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv() in "
                 "FixedLocalTupleComListInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _Potential>
inline real FixedLocalTupleComListInteractionTemplate<_Potential>::computeEnergyAA()
{
...
template <typename _Potential>
inline real FixedLocalTupleComListInteractionTemplate<_Potential>::computeEnergyAA(int atomtype)
{
...
template <typename _Potential>
inline real FixedLocalTupleComListInteractionTemplate<_Potential>::computeEnergyCG()
{
...
template <typename _Potential>
inline real FixedLocalTupleComListInteractionTemplate<_Potential>::computeEnergyCG(int atomtype)
{
...
template <typename _Potential>
inline void FixedLocalTupleComListInteractionTemplate<_Potential>::computeVirialX(
...
template <typename _Potential>
inline real FixedLocalTupleComListInteractionTemplate<_Potential>::computeVirial()
{
    ...
    for (FixedLocalTupleList::TupleList::Iterator it(*fixedtupleList); it.isValid(); ++it)
    {
        ...
        bc.getMinimumImageVectorBox(diff, com_origin[pid / N_Constrain],
                                    com_temporal[pid / N_Constrain]);
        bc.getMinimumImageVectorBox(dist, p->position(), com_origin[pid / N_Constrain]);
        force = potential->_computeForce(diff, total_mass[pid / N_Constrain]);
...
template <typename _Potential>
inline void FixedLocalTupleComListInteractionTemplate<_Potential>::computeVirialTensor(Tensor& w)
{
                                                                                       ...
                                                                                       real z)
{
    std::cout << "Warning! Calculating virial layerwise is not supported for "
                 "in FixedLocalTupleComListInteractionTemplate."
              << std::endl;
}
