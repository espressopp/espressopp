...
class StillingerWeberTripleTermLocal(
...
class VerletListStillingerWeberTripleTermLocal(
        InteractionLocal,
        interaction_VerletListStillingerWeberTripleTerm):
...
class FixedTripleListStillingerWeberTripleTermLocal(
        InteractionLocal, interaction_FixedTripleListStillingerWeberTripleTerm):
...
if pmi.isController:
    ...
    class VerletListStillingerWeberTripleTerm(
    ...
    class FixedTripleListStillingerWeberTripleTerm(
            Interaction, metaclass=pmi.Proxy):
        pmiproxydefs = dict(
