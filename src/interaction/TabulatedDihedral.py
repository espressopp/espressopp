...
class FixedQuadrupleListTabulatedDihedralLocal(
        InteractionLocal,
        interaction_FixedQuadrupleListTabulatedDihedral):
...
class FixedQuadrupleListTypesTabulatedDihedralLocal(
        InteractionLocal, interaction_FixedQuadrupleListTypesTabulatedDihedral):
...
if pmi.isController:
    ...
    class FixedQuadrupleListTabulatedDihedral(
    ...
    class FixedQuadrupleListTypesTabulatedDihedral(
            Interaction, metaclass=pmi.Proxy):
        pmiproxydefs = dict(
