...
void DihedralUniquePotential::registerPython() {
  ...
  real (DihedralUniquePotential::*computeEnergy1)(
      const Real3D& r21, const Real3D& r32, const Real3D& r43, const real phi0)
      const = &DihedralUniquePotential::computeEnergy;
  ...
  void (DihedralUniquePotential::*computeForce1)(
      ...
      const Real3D& r21, const Real3D& r32, const Real3D& r43, const real phi0)
      const = &DihedralUniquePotential::computeForce;
