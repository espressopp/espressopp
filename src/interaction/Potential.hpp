...
//////////////////////////////////////////////////
template <class Derived>
inline PotentialTemplate<Derived>::PotentialTemplate()
    : cutoff(infinity), cutoffSqr(infinity), shift(0.0), autoShift(false), colVar(1, 0.)
{
}

// Shift/cutoff handling
template <class Derived>
inline void PotentialTemplate<Derived>::setCutoff(real _cutoff)
{
    cutoff = _cutoff;
...
template <class Derived>
inline real PotentialTemplate<Derived>::getCutoff() const
{
    return cutoff;
}

template <class Derived>
inline void PotentialTemplate<Derived>::setShift(real _shift)
{
    autoShift = false;
    shift = _shift;
...
template <class Derived>
inline real PotentialTemplate<Derived>::getShift() const
{
    return shift;
}

template <class Derived>
inline real PotentialTemplate<Derived>::setAutoShift()
{
    autoShift = true;
...
template <class Derived>
inline void PotentialTemplate<Derived>::updateAutoShift()
{
...
template <class Derived>
inline void PotentialTemplate<Derived>::setColVarBondList(
    const std::shared_ptr<FixedPairList>& _fpl)
{
    colVarBondList = _fpl;
}

template <class Derived>
inline std::shared_ptr<FixedPairList> PotentialTemplate<Derived>::getColVarBondList() const
{
...
template <class Derived>
inline void PotentialTemplate<Derived>::setColVarAngleList(
    const std::shared_ptr<FixedTripleList>& _fpl)
{
    colVarAngleList = _fpl;
}

template <class Derived>
inline std::shared_ptr<FixedTripleList> PotentialTemplate<Derived>::getColVarAngleList() const
{
...
template <class Derived>
inline void PotentialTemplate<Derived>::setColVarDihedList(
    const std::shared_ptr<FixedQuadrupleList>& _fpl)
{
    colVarDihedList = _fpl;
}

template <class Derived>
inline std::shared_ptr<FixedQuadrupleList> PotentialTemplate<Derived>::getColVarDihedList() const
{
...
template <class Derived>
inline void PotentialTemplate<Derived>::setColVar(const RealND& cv)
{
    colVar = cv;
}
...
// Collective variables
template <class Derived>
inline void PotentialTemplate<Derived>::setColVar(const Real3D& dist, const bc::BC& bc)
{
    // In general, do nothing
}

template <class Derived>
inline RealND PotentialTemplate<Derived>::getColVar() const
{
    return colVar;
}

template <class Derived>
inline void PotentialTemplate<Derived>::computeColVarWeights(const Real3D& dist, const bc::BC& bc)
{
    // in general do nothing
}
...
// Energy computation
template <class Derived>
inline real PotentialTemplate<Derived>::computeEnergy(const Particle& p1, const Particle& p2) const
{
...
template <class Derived>
inline real PotentialTemplate<Derived>::computeEnergy(const Real3D& dist) const
{
    return computeEnergySqr(dist.sqr());
}

template <class Derived>
inline real PotentialTemplate<Derived>::computeEnergy(real dist) const
{
    return computeEnergySqr(dist * dist);
}

template <class Derived>
inline real PotentialTemplate<Derived>::computeEnergySqr(real distsqr) const
{
    return _computeEnergySqr(distsqr);
}

template <class Derived>
inline real PotentialTemplate<Derived>::_computeEnergy(const Particle& p1, const Particle& p2) const
{
    Real3D dist = p1.position() - p2.position();
    return _computeEnergy(dist);
}
...
template <class Derived>
inline real PotentialTemplate<Derived>::_computeEnergy(const Particle& p1,
                                                       const Particle& p2,
                                                       const Real3D& dist) const
{
    return _computeEnergy(dist);
...
template <class Derived>
inline real PotentialTemplate<Derived>::_computeEnergy(const Real3D& dist) const
{
    return _computeEnergySqr(dist.sqr());
}

template <class Derived>
inline real PotentialTemplate<Derived>::_computeEnergy(real dist) const
{
    return _computeEnergySqr(dist * dist);
}

template <class Derived>
inline real PotentialTemplate<Derived>::_computeEnergySqr(real distSqr) const
{
...
template <class Derived>
inline real PotentialTemplate<Derived>::_computeEnergyDeriv(const Particle& p1,
                                                            const Particle& p2) const
{
    std::cout << "Calculation of energy derivative wrt lambda not implemented for all potentials!"
              << std::endl;
    return 0.0;
}
...
// Force computation
template <class Derived>
inline Real3D PotentialTemplate<Derived>::computeForce(const Particle& p1, const Particle& p2) const
{
    Real3D dist = p1.position() - p2.position();
...
template <class Derived>
inline Real3D PotentialTemplate<Derived>::computeForce(const Real3D& dist) const
{
    Real3D force;
    if (!_computeForce(force, dist)) force = 0.0;
    return force;
}

template <class Derived>
inline bool PotentialTemplate<Derived>::_computeForce(Real3D& force,
                                                      const Particle& p1,
                                                      const Particle& p2) const
{
    Real3D dist = p1.position() - p2.position();
...
template <class Derived>
inline bool PotentialTemplate<Derived>::_computeForce(Real3D& force, const Real3D& dist) const
{
