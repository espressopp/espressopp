...
void LennardJonesExpand::registerPython() {
  ...
  class_<LennardJonesExpand, bases<Potential> >(
      ...
      .add_property("epsilon", &LennardJonesExpand::getEpsilon,
                    &LennardJonesExpand::setEpsilon)
      .add_property("sigma", &LennardJonesExpand::getSigma,
                    &LennardJonesExpand::setSigma)
      .add_property("delta", &LennardJonesExpand::getDelta,
                    &LennardJonesExpand::setDelta)
