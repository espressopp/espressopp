...
typedef class VerletListInteractionTemplate<LennardJonesExpand> VerletListLennardJonesExpand;
typedef class CellListAllPairsInteractionTemplate<LennardJonesExpand> CellListLennardJonesExpand;
typedef class FixedPairListInteractionTemplate<LennardJonesExpand> FixedPairListLennardJonesExpand;

//////////////////////////////////////////////////
// REGISTRATION WITH PYTHON
//////////////////////////////////////////////////
void LennardJonesExpand::registerPython() {
  using namespace espressopp::python;

  class_<LennardJonesExpand, bases<Potential> >("interaction_LennardJonesExpand",
  ...
  class_<VerletListLennardJonesExpand, bases<Interaction> >(
      ...
      .def("getPotential", &VerletListLennardJonesExpand::getPotential,
           return_value_policy<reference_existing_object>());

  class_<CellListLennardJonesExpand, bases<Interaction> >("interaction_CellListLennardJonesExpand",
