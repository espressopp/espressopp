...
//////////////////////////////////////////////////
template <class Derived>
inline SingleParticlePotentialTemplate<Derived>::SingleParticlePotentialTemplate()
{
}

// Energy computation
template <class Derived>
inline real SingleParticlePotentialTemplate<Derived>::computeEnergy(const Particle& p,
...
template <class Derived>
inline real SingleParticlePotentialTemplate<Derived>::_computeEnergy(const Particle& p,
                                                                     const bc::BC& bc) const
{
...
// Force computation
template <class Derived>
inline Real3D SingleParticlePotentialTemplate<Derived>::computeForce(const Particle& p,
                                                                     const bc::BC& bc) const
{
    Real3D force;
...
template <class Derived>
inline bool SingleParticlePotentialTemplate<Derived>::_computeForce(Real3D& force,
                                                                    const Particle& p,
                                                                    const bc::BC& bc) const
{
