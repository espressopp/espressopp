...
void LennardJonesEnergyCapped::registerPython() {
  ...
  class_<LennardJonesEnergyCapped, bases<Potential> >(
      ...
      .add_property("epsilon", &LennardJonesEnergyCapped::getEpsilon,
                    &LennardJonesEnergyCapped::setEpsilon)
      .add_property("caprad", &LennardJonesEnergyCapped::getCaprad,
                    &LennardJonesEnergyCapped::setCaprad)
