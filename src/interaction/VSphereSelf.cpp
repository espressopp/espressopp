...
{
typedef class VSphereSelfInteractionTemplate<VSphereSelf> SelfVSphere;

//////////////////////////////////////////////////
// REGISTRATION WITH PYTHON
//////////////////////////////////////////////////
void VSphereSelf::registerPython()
{
    ...
    class_<SelfVSphere, bases<Interaction> >(
        "interaction_SelfVSphere", init<std::shared_ptr<System>, std::shared_ptr<VSphereSelf> >())
