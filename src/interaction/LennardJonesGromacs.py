...
class LennardJonesGromacsLocal(
        PotentialLocal,
        interaction_LennardJonesGromacs):
...
class VerletListLennardJonesGromacsLocal(
        InteractionLocal,
...
class CellListLennardJonesGromacsLocal(
        InteractionLocal,
...
class FixedPairListLennardJonesGromacsLocal(
        InteractionLocal,
