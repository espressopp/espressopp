...
public:
    VerletListTripleInteractionTemplate(std::shared_ptr<System> _system,
                                        std::shared_ptr<VerletListTriple> _verletlisttriple)
    ...
    void setVerletListTriple(std::shared_ptr<VerletListTriple> _verletlisttriple)
    {
        verletListTriple = _verletlisttriple;
    }
    std::shared_ptr<VerletListTriple> getVerletListTriple() { return verletListTriple; }
...
//////////////////////////////////////////////////
template <typename _ThreeBodyPotential>
inline void VerletListTripleInteractionTemplate<_ThreeBodyPotential>::addForces()
{
...
template <typename _ThreeBodyPotential>
inline real VerletListTripleInteractionTemplate<_ThreeBodyPotential>::computeEnergy()
{
...
template <typename _ThreeBodyPotential>
inline real VerletListTripleInteractionTemplate<_ThreeBodyPotential>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv() in "
                 "VerletListTripleInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _ThreeBodyPotential>
inline real VerletListTripleInteractionTemplate<_ThreeBodyPotential>::computeEnergyAA()
{
    std::cout << "Warning! At the moment computeEnergyAA() in VerletListTripleInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _ThreeBodyPotential>
inline real VerletListTripleInteractionTemplate<_ThreeBodyPotential>::computeEnergyAA(int atomtype)
{
...
template <typename _ThreeBodyPotential>
inline real VerletListTripleInteractionTemplate<_ThreeBodyPotential>::computeEnergyCG()
{
    std::cout << "Warning! At the moment computeEnergyCG() in VerletListTripleInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _ThreeBodyPotential>
inline real VerletListTripleInteractionTemplate<_ThreeBodyPotential>::computeEnergyCG(int atomtype)
{
...
template <typename _ThreeBodyPotential>
inline void VerletListTripleInteractionTemplate<_ThreeBodyPotential>::computeVirialX(
    std::vector<real> &p_xx_total, int bins)
{
    std::cout << "Warning! At the moment computeVirialX in VerletListTripleInteractionTemplate "
                 "does not work."
              << std::endl
...
template <typename _ThreeBodyPotential>
inline real VerletListTripleInteractionTemplate<_ThreeBodyPotential>::computeVirial()
{
...
template <typename _ThreeBodyPotential>
inline void VerletListTripleInteractionTemplate<_ThreeBodyPotential>::computeVirialTensor(Tensor &w)
{
...
template <typename _ThreeBodyPotential>
inline real VerletListTripleInteractionTemplate<_ThreeBodyPotential>::getMaxCutoff()
{
    real cutoff = 0.0;
