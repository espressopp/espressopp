...
void PotentialVSpherePair::registerPython() {
  ...
  real (PotentialVSpherePair::*computeEnergy1)(const Real3D& dist,
                                               real& sigmaij) const =
  ...
  python::list (PotentialVSpherePair::*computeForce)(
  ...
  class_<PotentialVSpherePair, boost::noncopyable>(
      ...
      .add_property("cutoff", &PotentialVSpherePair::getCutoff,
                    &PotentialVSpherePair::setCutoff)
      .add_property("shift", &PotentialVSpherePair::getShift,
