...
public:
    ...
    LennardJonesEnergyCapped() : epsilon(0.0), sigma(0.0)
    {
        setShift(0.0);
        setCutoff(infinity);
        preset();
    ...
    LennardJonesEnergyCapped(real _epsilon, real _sigma, real _cutoff, real _caprad, real _shift)
    ...
    LennardJonesEnergyCapped(real _epsilon, real _sigma, real _cutoff, real _caprad)
        : epsilon(_epsilon), sigma(_sigma), caprad(_caprad)
    {
        autoShift = false;
        setCutoff(_cutoff);
...
{
    static boost::python::tuple getinitargs(LennardJonesEnergyCapped const& pot)
    {
        real eps;
        real sig;
        real rc;
