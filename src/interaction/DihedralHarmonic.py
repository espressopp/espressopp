...
class DihedralHarmonicLocal(
        DihedralPotentialLocal,
        interaction_DihedralHarmonic):
...
class FixedQuadrupleListTypesDihedralHarmonicLocal(
        InteractionLocal,
...
if pmi.isController:
    ...
    class FixedQuadrupleListTypesDihedralHarmonic(
