...
// typedef class
// VerletListHadressInteractionTemplate<ReactionFieldGeneralizedTI, Tabulated>
...
void ReactionFieldGeneralizedTI::registerPython() {
  ...
  class_<ReactionFieldGeneralizedTI, bases<Potential> >(
      ...
      .add_property("prefactor", &ReactionFieldGeneralizedTI::getPrefactor,
                    &ReactionFieldGeneralizedTI::setPrefactor);

  // class_<VerletListReactionFieldGeneralizedTI, bases<Interaction> >
  //    ("interaction_VerletListReactionFieldGeneralizedTI", init<
  //    shared_ptr<VerletList> >())
  //    .def("setPotential",
  //    &VerletListReactionFieldGeneralizedTI::setPotential)
  //    .def("getPotential",
  //    &VerletListReactionFieldGeneralizedTI::getPotentialPtr)
  //;
  ...
  //    .def("setPotentialAT",
  //    &VerletListHadressReactionFieldGeneralizedTI::setPotentialAT)
  //    .def("setPotentialCG",
  //    &VerletListHadressReactionFieldGeneralizedTI::setPotentialCG);
  //;
}
}
}
