...
public:
    ...
    static real computePhi(const Real3D& dist21, const Real3D& dist32, const Real3D& dist43);
...
public:
    ...
    real _computeEnergy(const Real3D& dist21, const Real3D& dist32, const Real3D& dist43) const;
...
//////////////////////////////////////////////////
template <class Derived>
inline DihedralPotentialTemplate<Derived>::DihedralPotentialTemplate()
...
template <class Derived>
inline void DihedralPotentialTemplate<Derived>::setCutoff(real _cutoff)
{
    cutoff = _cutoff;
...
template <class Derived>
inline real DihedralPotentialTemplate<Derived>::getCutoff() const
{
    return cutoff;
}
...
template <class Derived>
inline void DihedralPotentialTemplate<Derived>::setColVarBondList(
...
template <class Derived>
inline std::shared_ptr<FixedPairList> DihedralPotentialTemplate<Derived>::getColVarBondList() const
{
...
// Pair list for collective variables
template <class Derived>
inline void DihedralPotentialTemplate<Derived>::setColVarAngleList(
...
template <class Derived>
inline std::shared_ptr<FixedTripleList> DihedralPotentialTemplate<Derived>::getColVarAngleList()
    const
{
...
template <class Derived>
inline void DihedralPotentialTemplate<Derived>::setColVarDihedList(
    const std::shared_ptr<FixedQuadrupleList>& _fql)
{
    colVarDihedList = _fql;
}

template <class Derived>
inline std::shared_ptr<FixedQuadrupleList> DihedralPotentialTemplate<Derived>::getColVarDihedList()
    const
{
...
template <class Derived>
inline void DihedralPotentialTemplate<Derived>::setColVar(const RealND& cv)
{
    colVar = cv;
}
...
// Collective variables
template <class Derived>
inline void DihedralPotentialTemplate<Derived>::setColVar(const Real3D& dist21,
                                                          const Real3D& dist32,
                                                          const Real3D& dist43,
                                                          const bc::BC& bc)
{
...
template <class Derived>
inline RealND DihedralPotentialTemplate<Derived>::getColVar() const
{
    return colVar;
}

template <class Derived>
inline void DihedralPotentialTemplate<Derived>::computeColVarWeights(const Real3D& dist21,
                                                                     const Real3D& dist32,
                                                                     const Real3D& dist43,
                                                                     const bc::BC& bc)
{
...
// Energy computation
template <class Derived>
inline real DihedralPotentialTemplate<Derived>::computeEnergy(const Real3D& dist21,
                                                              const Real3D& dist32,
                                                              const Real3D& dist43) const
{
...
template <class Derived>
inline real DihedralPotentialTemplate<Derived>::computeEnergy(real phi) const
{
    return _computeEnergy(phi);
}

template <class Derived>
inline real DihedralPotentialTemplate<Derived>::_computeEnergy(const Real3D& r21,
                                                               const Real3D& r32,
...
template <class Derived>
inline real DihedralPotentialTemplate<Derived>::_computeEnergy(real phi) const
{
...
// Force computation
template <class Derived>
inline void DihedralPotentialTemplate<Derived>::computeForce(Real3D& force1,
                                                             Real3D& force2,
                                                             Real3D& force3,
                                                             Real3D& force4,
                                                             const Real3D& dist21,
...
template <class Derived>
inline void DihedralPotentialTemplate<Derived>::_computeForce(Real3D& force1,
                                                              Real3D& force2,
                                                              Real3D& force3,
                                                              Real3D& force4,
                                                              const Real3D& dist21,
...
template <class Derived>
inline real DihedralPotentialTemplate<Derived>::computeForce(real phi) const
{
