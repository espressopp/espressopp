...
public:
    VerletListHadressInteractionTemplate(std::shared_ptr<VerletListAdress> _verletList,
...
//////////////////////////////////////////////////
template <typename _PotentialAT, typename _PotentialCG>
inline void VerletListHadressInteractionTemplate<_PotentialAT, _PotentialCG>::addForces()
{
    ...
    {  // Iterate over all particles
        ...
        {  //   only chose those in the hybrid region
            ...
            if (verletList->getAdrRegionType())
            {
                ...
                mindriftforce *=
                    (0.5 *
                     energydiff.find(&vp)->second);  // get the energy differences which were
                                                     // calculated previously and put in drift force
...
template <typename _PotentialAT, typename _PotentialCG>
inline real VerletListHadressInteractionTemplate<_PotentialAT, _PotentialCG>::computeEnergy()
{
...
template <typename _PotentialAT, typename _PotentialCG>
inline real VerletListHadressInteractionTemplate<_PotentialAT, _PotentialCG>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv() in "
                 "VerletListHadressInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _PotentialAT, typename _PotentialCG>
inline real VerletListHadressInteractionTemplate<_PotentialAT, _PotentialCG>::computeEnergyAA()
{
...
template <typename _PotentialAT, typename _PotentialCG>
inline real VerletListHadressInteractionTemplate<_PotentialAT, _PotentialCG>::computeEnergyCG()
{
...
template <typename _PotentialAT, typename _PotentialCG>
inline real VerletListHadressInteractionTemplate<_PotentialAT, _PotentialCG>::computeVirial()
{
...
template <typename _PotentialAT, typename _PotentialCG>
inline real VerletListHadressInteractionTemplate<_PotentialAT, _PotentialCG>::getMaxCutoff()
{
    real cutoff = 0.0;
