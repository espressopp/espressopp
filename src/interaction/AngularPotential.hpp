...
public:
    ...
    virtual void setColVar(const Real3D& dist12, const Real3D& dist32, const bc::BC& bc) = 0;
...
public:
    ...
    virtual void setColVar(const Real3D& dist12, const Real3D& dist32, const bc::BC& bc);
    virtual RealND getColVar() const;

    virtual void computeColVarWeights(const Real3D& dist12, const Real3D& dist32, const bc::BC& bc);
    ...
    void _computeForce(Real3D& force12,
                       Real3D& force32,
                       const Particle& p1,
                       const Particle& p2,
                       const Particle& p3) const;

    bool _computeForce(Real3D& force12,
                       Real3D& force32,
                       const Real3D& dist12,
                       const Real3D& dist32) const;
...
//////////////////////////////////////////////////
template <class Derived>
inline AngularPotentialTemplate<Derived>::AngularPotentialTemplate()
...
template <class Derived>
inline void AngularPotentialTemplate<Derived>::setCutoff(real _cutoff)
{
    cutoff = _cutoff;
...
template <class Derived>
inline real AngularPotentialTemplate<Derived>::getCutoff() const
{
    return cutoff;
}
...
template <class Derived>
inline void AngularPotentialTemplate<Derived>::setColVarBondList(
...
template <class Derived>
inline std::shared_ptr<FixedPairList> AngularPotentialTemplate<Derived>::getColVarBondList() const
{
...
template <class Derived>
inline void AngularPotentialTemplate<Derived>::setColVarAngleList(
...
template <class Derived>
inline std::shared_ptr<FixedTripleList> AngularPotentialTemplate<Derived>::getColVarAngleList()
    const
{
...
template <class Derived>
inline void AngularPotentialTemplate<Derived>::setColVarDihedList(
...
template <class Derived>
inline std::shared_ptr<FixedQuadrupleList> AngularPotentialTemplate<Derived>::getColVarDihedList()
    const
{
...
template <class Derived>
inline void AngularPotentialTemplate<Derived>::setColVar(const RealND& cv)
{
    colVar = cv;
}
...
// Collective variables
template <class Derived>
inline void AngularPotentialTemplate<Derived>::setColVar(const Real3D& dist12,
                                                         const Real3D& dist32,
                                                         const bc::BC& bc)
{
...
template <class Derived>
inline RealND AngularPotentialTemplate<Derived>::getColVar() const
{
    return colVar;
}

template <class Derived>
inline void AngularPotentialTemplate<Derived>::computeColVarWeights(const Real3D& dist12,
                                                                    const Real3D& dist32,
                                                                    const bc::BC& bc)
{
    // in general do nothing
...
// Energy computation
template <class Derived>
inline real AngularPotentialTemplate<Derived>::computeEnergy(const Particle& p1,
                                                             const Particle& p2,
                                                             const Particle& p3) const
{
...
template <class Derived>
inline real AngularPotentialTemplate<Derived>::computeEnergy(const Real3D& dist12,
                                                             const Real3D& dist32) const
{
...
template <class Derived>
inline real AngularPotentialTemplate<Derived>::computeEnergy(real theta) const
{
    return _computeEnergy(theta);  // a bug was here (it was: return computeEnergy(theta);)
}

template <class Derived>
inline real AngularPotentialTemplate<Derived>::_computeEnergy(const Particle& p1,
                                                              const Particle& p2,
                                                              const Particle& p3) const
{
    Real3D dist12 = p1.position() - p2.position();
...
template <class Derived>
inline real AngularPotentialTemplate<Derived>::_computeEnergy(const Real3D& dist12,
                                                              const Real3D& dist32) const
{
...
template <class Derived>
inline real AngularPotentialTemplate<Derived>::_computeEnergy(real theta) const
{
...
// Force computation
template <class Derived>
inline void AngularPotentialTemplate<Derived>::computeForce(Real3D& force12,
                                                            Real3D& force32,
                                                            const Particle& p1,
                                                            const Particle& p2,
                                                            const Particle& p3) const
...
template <class Derived>
inline void AngularPotentialTemplate<Derived>::_computeForce(Real3D& force12,
                                                             Real3D& force32,
                                                             const Particle& p1,
                                                             const Particle& p2,
                                                             const Particle& p3) const
...
template <class Derived>
inline bool AngularPotentialTemplate<Derived>::_computeForce(Real3D& force12,
                                                             Real3D& force32,
                                                             const Real3D& dist12,
                                                             const Real3D& dist32) const
{
...
template <class Derived>
inline real AngularPotentialTemplate<Derived>::computeForce(real theta) const
{
