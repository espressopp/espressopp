...
typedef class VerletListInteractionTemplate<LennardJonesCapped> VerletListLennardJonesCapped;
...
void LennardJonesCapped::registerPython() {
  ...
  class_<LennardJonesCapped, bases<Potential> >("interaction_LennardJonesCapped",
  ...
  class_<CellListLennardJonesCapped, bases<Interaction> >("interaction_CellListLennardJonesCapped",
