...
typedef class VerletListHadressInteractionTemplate<LennardJonesCapped,
                                                   Tabulated>
...
//////////////////////////////////////////////////
void LennardJonesCapped::registerPython() {
  ...
  class_<LennardJonesCapped, bases<Potential> >(
      ...
      .add_property("sigma", &LennardJonesCapped::getSigma,
                    &LennardJonesCapped::setSigma)
      .add_property("epsilon", &LennardJonesCapped::getEpsilon,
                    &LennardJonesCapped::setEpsilon)
      .add_property("caprad", &LennardJonesCapped::getCaprad,
                    &LennardJonesCapped::setCaprad)
  ...
  class_<VerletListLennardJonesCapped, bases<Interaction> >(
      ...
      .def("getPotential", &VerletListLennardJonesCapped::getPotential,
           return_value_policy<reference_existing_object>());
  ...
  class_<VerletListAdressLennardJonesCapped, bases<Interaction> >(
      ...
      .def("setPotentialAT",
           &VerletListAdressLennardJonesCapped::setPotentialAT)
      .def("setPotentialCG",
           &VerletListAdressLennardJonesCapped::setPotentialCG)
      .def("getPotentialAT",
           &VerletListAdressLennardJonesCapped::getPotentialAT,
           return_value_policy<reference_existing_object>())
      .def("getPotentialCG",
           &VerletListAdressLennardJonesCapped::getPotentialCG,
           return_value_policy<reference_existing_object>());
  ;
  ...
  class_<VerletListHadressLennardJonesCapped, bases<Interaction> >(
      ...
      init<shared_ptr<VerletListAdress>, shared_ptr<FixedTupleListAdress> >())
      .def("setPotentialAT",
           &VerletListHadressLennardJonesCapped::setPotentialAT)
      .def("setPotentialCG",
           &VerletListHadressLennardJonesCapped::setPotentialCG)
      .def("getPotentialAT",
           &VerletListHadressLennardJonesCapped::getPotentialAT,
           return_value_policy<reference_existing_object>())
      .def("getPotentialCG",
           &VerletListHadressLennardJonesCapped::getPotentialCG,
           return_value_policy<reference_existing_object>());
  ;
  ...
  class_<CellListLennardJonesCapped, bases<Interaction> >(
      ...
      .def("getPotential", &CellListLennardJonesCapped::getPotential,
           return_value_policy<reference_existing_object>());
  ;
