...
//////////////////////////////////////////////////
void StillingerWeberPairTermCapped::registerPython()
{
    ...
    class_<StillingerWeberPairTermCapped, bases<Potential> >(
        ...
        .add_property("epsilon", &StillingerWeberPairTermCapped::getEpsilon,
                      &StillingerWeberPairTermCapped::setEpsilon)
        .add_property("caprad", &StillingerWeberPairTermCapped::getCaprad,
                      &StillingerWeberPairTermCapped::setCaprad)
    ...
    class_<FixedPairListStillingerWeberPairTermCapped, bases<Interaction> >(
        ...
        init<std::shared_ptr<System>, std::shared_ptr<FixedPairList>,
             std::shared_ptr<StillingerWeberPairTermCapped> >())
