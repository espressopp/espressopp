...
public:
    VerletListAdressATATInteractionTemplate(std::shared_ptr<VerletListAdress> _verletList,
...
//////////////////////////////////////////////////
template <typename _Potential1, typename _Potential2>
inline void VerletListAdressATATInteractionTemplate<_Potential1, _Potential2>::addForces()
{
...
template <typename _Potential1, typename _Potential2>
inline real VerletListAdressATATInteractionTemplate<_Potential1, _Potential2>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv in "
                 "VerletListAdressATATInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _Potential1, typename _Potential2>
inline real VerletListAdressATATInteractionTemplate<_Potential1, _Potential2>::computeEnergyAA()
{
...
template <typename _Potential1, typename _Potential2>
inline real VerletListAdressATATInteractionTemplate<_Potential1, _Potential2>::computeEnergyCG()
{
...
template <typename _Potential1, typename _Potential2>
inline real VerletListAdressATATInteractionTemplate<_Potential1, _Potential2>::computeVirial()
{
    std::cout << "Warning! At the moment computeVirial in VerletListAdressATATInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential1, typename _Potential2>
inline real VerletListAdressATATInteractionTemplate<_Potential1, _Potential2>::getMaxCutoff()
{
    real cutoff = 0.0;
