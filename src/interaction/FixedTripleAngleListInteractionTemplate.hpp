...
public:
    FixedTripleAngleListInteractionTemplate(std::shared_ptr<System> _system,
    ...
    void setFixedTripleAngleList(std::shared_ptr<FixedTripleAngleList> _fixedtripleList)
    {
        fixedtripleList = _fixedtripleList;
    }

    std::shared_ptr<FixedTripleAngleList> getFixedTripleList() { return fixedtripleList; }
...
template <typename _AngularPotential>
inline real FixedTripleAngleListInteractionTemplate<_AngularPotential>::computeEnergy()
{
...
template <typename _AngularPotential>
inline real FixedTripleAngleListInteractionTemplate<_AngularPotential>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv() in "
                 "FixedTripleAngleListInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _AngularPotential>
inline real FixedTripleAngleListInteractionTemplate<_AngularPotential>::computeEnergyAA()
{
...
template <typename _AngularPotential>
inline real FixedTripleAngleListInteractionTemplate<_AngularPotential>::computeEnergyCG()
{
...
template <typename _AngularPotential>
inline real FixedTripleAngleListInteractionTemplate<_AngularPotential>::computeVirial()
{
...
template <typename _AngularPotential>
inline real FixedTripleAngleListInteractionTemplate<_AngularPotential>::getMaxCutoff()
{
