...
public:
    FixedPairDistListInteractionTemplate(std::shared_ptr<System> system,
                                         std::shared_ptr<FixedPairDistList> _fixedPairDistList,
                                         std::shared_ptr<Potential> _potential)
        : SystemAccess(system), fixedPairDistList(_fixedPairDistList), potential(_potential)
    {
        if (!potential)
        {
    ...
    void setFixedPairList(std::shared_ptr<FixedPairDistList> _fixedPairDistList)
    {
        fixedPairDistList = _fixedPairDistList;
    }

    std::shared_ptr<FixedPairDistList> getFixedPairList() { return fixedPairDistList; }
...
template <typename _Potential>
inline real FixedPairDistListInteractionTemplate<_Potential>::computeEnergy()
{
...
template <typename _Potential>
inline real FixedPairDistListInteractionTemplate<_Potential>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv() in "
                 "FixedPairDistListInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _Potential>
inline real FixedPairDistListInteractionTemplate<_Potential>::computeEnergyAA()
{
    std::cout << "Warning! At the moment computeEnergyAA() in FixedPairDistListInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential>
inline real FixedPairDistListInteractionTemplate<_Potential>::computeEnergyAA(int atomtype)
{
...
template <typename _Potential>
inline real FixedPairDistListInteractionTemplate<_Potential>::computeEnergyCG()
{
    std::cout << "Warning! At the moment computeEnergyCG() in FixedPairDistListInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential>
inline real FixedPairDistListInteractionTemplate<_Potential>::computeEnergyCG(int atomtype)
{
...
template <typename _Potential>
inline real FixedPairDistListInteractionTemplate<_Potential>::computeVirial()
{
...
template <typename _Potential>
inline real FixedPairDistListInteractionTemplate<_Potential>::getMaxCutoff()
{
