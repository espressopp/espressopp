...
public:
    ...
    LennardJonesGeneric() : epsilon(0.0), sigma(0.0), a(0), b(0)
    {
    ...
    LennardJonesGeneric(real _epsilon, real _sigma, int _a, int _b, real _cutoff)
    ...
    LennardJonesGeneric(real _epsilon, real _sigma, int _a, int _b, real _cutoff, real _shift)
        : epsilon(_epsilon), sigma(_sigma), a(_a), b(_b)
    {
...
{
    static boost::python::tuple getinitargs(LennardJonesGeneric const& pot)
    {
        real eps;
        real sig;
        int a;
