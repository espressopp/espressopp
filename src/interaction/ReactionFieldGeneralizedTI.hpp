 ...
 */
class ReactionFieldGeneralizedTI : public PotentialTemplate<ReactionFieldGeneralizedTI>
{
private:
    real prefactor;
    real kappa;
...
public:
    ...
    ReactionFieldGeneralizedTI(real _prefactor,
                               real _kappa,
                               real _eps1,
                               real _eps2,
                               real _cutoff,
    ...
    // Setter and getter
    void setPrefactor(real _prefactor) { prefactor = _prefactor; }
    real getPrefactor() const { return prefactor; }

    void addPid(longint pid) { pidsTI.insert(pid); }
...
{
    static boost::python::tuple getinitargs(ReactionFieldGeneralizedTI const& pot)
    {
