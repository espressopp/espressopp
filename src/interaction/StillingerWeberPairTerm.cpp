...
typedef class VerletListAdressInteractionTemplate<StillingerWeberPairTerm,
                                                  Tabulated>
    VerletListAdressStillingerWeberPairTerm;
typedef class VerletListHadressInteractionTemplate<StillingerWeberPairTerm,
                                                   Tabulated>
...
//////////////////////////////////////////////////
void StillingerWeberPairTerm::registerPython() {
  using namespace espressopp::python;

  class_<StillingerWeberPairTerm, bases<Potential> >(
      "interaction_StillingerWeberPairTerm",
      init<real, real, real, real, real, real, real>())
      //.def(init< real, real, real, real, real, real, real, real>())
      .add_property("A", &StillingerWeberPairTerm::getA,
                    &StillingerWeberPairTerm::setA)
      .add_property("B", &StillingerWeberPairTerm::getB,
                    &StillingerWeberPairTerm::setB)
      .add_property("p", &StillingerWeberPairTerm::getP,
                    &StillingerWeberPairTerm::setP)
      .add_property("q", &StillingerWeberPairTerm::getQ,
                    &StillingerWeberPairTerm::setQ)
      .add_property("sigma", &StillingerWeberPairTerm::getSigma,
                    &StillingerWeberPairTerm::setSigma)
      .add_property("epsilon", &StillingerWeberPairTerm::getEpsilon,
                    &StillingerWeberPairTerm::setEpsilon);
  ...
  class_<VerletListStillingerWeberPairTerm, bases<Interaction> >(
      ...
      .def("setPotential", &VerletListStillingerWeberPairTerm::setPotential,
           return_value_policy<reference_existing_object>())
      .def("getPotential", &VerletListStillingerWeberPairTerm::getPotential,
           return_value_policy<reference_existing_object>());
  ...
  class_<VerletListAdressStillingerWeberPairTerm, bases<Interaction> >(
      ...
      .def("setPotentialAT",
           &VerletListAdressStillingerWeberPairTerm::setPotentialAT)
      .def("setPotentialCG",
           &VerletListAdressStillingerWeberPairTerm::setPotentialCG);
  ;
  ...
  class_<VerletListHadressStillingerWeberPairTerm, bases<Interaction> >(
      ...
      init<shared_ptr<VerletListAdress>, shared_ptr<FixedTupleListAdress> >())
      .def("setPotentialAT",
           &VerletListHadressStillingerWeberPairTerm::setPotentialAT)
      .def("setPotentialCG",
           &VerletListHadressStillingerWeberPairTerm::setPotentialCG);
  ;
  ...
  class_<FixedPairListStillingerWeberPairTerm, bases<Interaction> >(
      ...
      init<shared_ptr<System>, shared_ptr<FixedPairList>,
           shared_ptr<StillingerWeberPairTerm> >())
