...
void TersoffTripleTerm::registerPython() {
  ...
  class_<TersoffTripleTerm, bases<AngularPotential> >(
      ...
      init<real, real, real, real, real, real, real, real, real, real, real,
           real, real, real>())
  ...
  class_<VerletListTersoffTripleTerm, bases<Interaction> >(
      ...
      .def("getVerletListTriple",
           &VerletListTersoffTripleTerm::getVerletListTriple)
