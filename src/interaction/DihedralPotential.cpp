...
{
real DihedralPotential::computePhi(const Real3D& r21, const Real3D& r32, const Real3D& r43)
{
...
//////////////////////////////////////////////////
void DihedralPotential::registerPython()
{
    using namespace espressopp::python;

    real (DihedralPotential::*computeEnergy1)(const Real3D& dist21, const Real3D& dist32,
    ...
    class_<DihedralPotential, boost::noncopyable>("interaction_DihedralPotential", no_init)
        .add_property("cutoff", &DihedralPotential::getCutoff, &DihedralPotential::setCutoff)
        .add_property("colVarBondList", &DihedralPotential::getColVarBondList,
                      &DihedralPotential::setColVarBondList)
        .add_property("colVarAngleList", &DihedralPotential::getColVarAngleList,
                      &DihedralPotential::setColVarAngleList)
        .add_property("colVar", &DihedralPotential::getColVar)
