...
public:
    VerletListVSphereInteractionTemplate(std::shared_ptr<VerletList> _verletList)
...
//////////////////////////////////////////////////
template <typename _Potential>
inline void VerletListVSphereInteractionTemplate<_Potential>::addForces()
{
...
template <typename _Potential>
inline real VerletListVSphereInteractionTemplate<_Potential>::computeEnergy()
{
...
template <typename _Potential>
inline real VerletListVSphereInteractionTemplate<_Potential>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv() in "
                 "VerletListVSphereInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _Potential>
inline real VerletListVSphereInteractionTemplate<_Potential>::computeEnergyAA()
{
    std::cout << "Warning! At the moment computeEnergyAA() in VerletListVSphereInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential>
inline real VerletListVSphereInteractionTemplate<_Potential>::computeEnergyAA(int atomtype)
{
...
template <typename _Potential>
inline real VerletListVSphereInteractionTemplate<_Potential>::computeEnergyCG()
{
    std::cout << "Warning! At the moment computeEnergyCG() in VerletListVSphereInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential>
inline real VerletListVSphereInteractionTemplate<_Potential>::computeEnergyCG(int atomtype)
{
...
template <typename _Potential>
inline void VerletListVSphereInteractionTemplate<_Potential>::computeVirialX(
    std::vector<real> &p_xx_total, int bins)
{
    std::cout
        << "Warning! At the moment computeVirialX in VerletListInteractionTemplate does not work."
        << std::endl
...
template <typename _Potential>
inline real VerletListVSphereInteractionTemplate<_Potential>::computeVirial()
{
...
template <typename _Potential>
inline void VerletListVSphereInteractionTemplate<_Potential>::computeVirialTensor(Tensor &w)
{
...
template <typename _Potential>
inline void VerletListVSphereInteractionTemplate<_Potential>::computeVirialTensor(Tensor &w, real z)
{
    LOG4ESPP_INFO(theLogger, "compute the virial tensor for the Verlet List");
...
template <typename _Potential>
inline void VerletListVSphereInteractionTemplate<_Potential>::computeVirialTensor(Tensor *w, int n)
{
    LOG4ESPP_INFO(theLogger, "compute the virial tensor for the Verlet List");
...
template <typename _Potential>
inline real VerletListVSphereInteractionTemplate<_Potential>::getMaxCutoff()
{
    real cutoff = 0.0;
