...
public:
    ...
    void setFixedQuadrupleAngleList(
        std::shared_ptr<FixedQuadrupleAngleList> _fixedQuadrupleAngleList)
    {
        fixedQuadrupleAngleList = _fixedQuadrupleAngleList;
    }
...
//////////////////////////////////////////////////
template <typename _DihedralPotential>
inline void FixedQuadrupleAngleListInteractionTemplate<_DihedralPotential>::addForces()
{
    LOG4ESPP_INFO(theLogger, "add forces computed by FixedQuadrupleAngleList");

    const bc::BC &bc = *getSystemRef().bc;  // boundary conditions

    for (FixedQuadrupleAngleList::QuadrupleList::Iterator it(*fixedQuadrupleAngleList);
         it.isValid(); ++it)
    {
        ...
        real currentAngle =
            fixedQuadrupleAngleList->getAngle(p1.getId(), p2.getId(), p3.getId(), p4.getId());

        potential->_computeForce(force1, force2, force3, force4, r21, r32, r43, currentAngle);
        p1.force() += force1;
...
template <typename _DihedralPotential>
inline real FixedQuadrupleAngleListInteractionTemplate<_DihedralPotential>::computeEnergy()
{
...
template <typename _DihedralPotential>
inline real FixedQuadrupleAngleListInteractionTemplate<_DihedralPotential>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv() in "
                 "FixedQuadrupleAngleListInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _DihedralPotential>
inline real FixedQuadrupleAngleListInteractionTemplate<_DihedralPotential>::computeEnergyAA()
{
...
template <typename _DihedralPotential>
inline real FixedQuadrupleAngleListInteractionTemplate<_DihedralPotential>::computeEnergyCG()
{
...
template <typename _DihedralPotential>
inline void FixedQuadrupleAngleListInteractionTemplate<_DihedralPotential>::computeVirialX(
...
template <typename _DihedralPotential>
inline real FixedQuadrupleAngleListInteractionTemplate<_DihedralPotential>::computeVirial()
{
...
template <typename _DihedralPotential>
inline void FixedQuadrupleAngleListInteractionTemplate<_DihedralPotential>::computeVirialTensor(
    Tensor &w)
{
    ...
    Tensor &w, real z)
{
    ...
    std::cout << "Warning!!! computeVirialTensor in specified volume doesn't work for "
                 "FixedQuadrupleAngleListInteractionTemplate at the moment"
              << std::endl;
...
template <typename _DihedralPotential>
inline real FixedQuadrupleAngleListInteractionTemplate<_DihedralPotential>::getMaxCutoff()
{
