...
public:
    VerletListHadressCGInteractionTemplate(std::shared_ptr<VerletListAdress> _verletList,
...
//////////////////////////////////////////////////
template <typename _Potential>
inline void VerletListHadressCGInteractionTemplate<_Potential>::addForces()
{
    ...
    for (PairList::Iterator it(verletList->getAdrPairs()); it.isValid(); ++it)
    {
        ...
        {  // calculate VP force if both VP are outside AT region (CG-HY, HY-HY)
            ...
            if (w12 != 0.0)
            {  // at least one particle in hybrid region => need to do the energy calculation
...
template <typename _Potential>
inline real VerletListHadressCGInteractionTemplate<_Potential>::computeEnergy()
{
...
template <typename _Potential>
inline real VerletListHadressCGInteractionTemplate<_Potential>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv in "
                 "VerletListHadressCGInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _Potential>
inline real VerletListHadressCGInteractionTemplate<_Potential>::computeEnergyAA()
{
    std::cout << "Warning! At the moment computeEnergyAA in VerletListHadressCGInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential>
inline real VerletListHadressCGInteractionTemplate<_Potential>::computeEnergyAA(int atomtype)
{
...
template <typename _Potential>
inline real VerletListHadressCGInteractionTemplate<_Potential>::computeEnergyCG()
{
    std::cout << "Warning! At the moment computeEnergyCG in VerletListHadressCGInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential>
inline real VerletListHadressCGInteractionTemplate<_Potential>::computeEnergyCG(int atomtype)
{
...
template <typename _Potential>
inline void VerletListHadressCGInteractionTemplate<_Potential>::computeVirialX(
    std::vector<real>& p_xx_total, int bins)
{
    std::cout << "Warning! At the moment computeVirialX in VerletListHadressCGInteractionTemplate "
                 "does'n work"
              << std::endl;
}

template <typename _Potential>
inline real VerletListHadressCGInteractionTemplate<_Potential>::computeVirial()
{
    LOG4ESPP_INFO(theLogger, "compute the virial for the Verlet List");
    std::cout << "Warning! At the moment computeVirial in VerletListHadressCGInteractionTemplate "
                 "does not work."
              << std::endl;
    return 0.0;
}
...
template <typename _Potential>
inline void VerletListHadressCGInteractionTemplate<_Potential>::computeVirialTensor(Tensor& w)
{
    ...
    std::cout << "Warning! At the moment computeVirialTensor in "
                 "VerletListHadressCGInteractionTemplate does'n work"
              << std::endl;
}
...
template <typename _Potential>
inline real VerletListHadressCGInteractionTemplate<_Potential>::getMaxCutoff()
{
    real cutoff = 0.0;
