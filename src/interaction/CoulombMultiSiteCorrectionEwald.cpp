  ...
  namespace interaction {
    ...
    CoulombMultiSiteCorrectionEwald::registerPython() {
      ...
      class_< CoulombMultiSiteCorrectionEwald, bases< Potential > >
        ...
        .add_property("alpha", &CoulombMultiSiteCorrectionEwald::getAlpha, &CoulombMultiSiteCorrectionEwald::setAlpha)
        .add_property("prefactor", &CoulombMultiSiteCorrectionEwald::getPrefactor, &CoulombMultiSiteCorrectionEwald::setPrefactor)
      ;
