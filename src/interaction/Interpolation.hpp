...
/*********************************************/
template <class Derived>
inline InterpolationTemplate<Derived>::InterpolationTemplate()
{
}

template <class Derived>
inline real InterpolationTemplate<Derived>::getEnergy(real r) const
{
    return derived_this()->getEnergyRaw(r);
}

template <class Derived>
inline real InterpolationTemplate<Derived>::getForce(real r) const
{
    return derived_this()->getForceRaw(r);
}

template <class Derived>
inline void InterpolationTemplate<Derived>::read(mpi::communicator comm, const char* file)
{
