...
void LennardJonesSoftcoreTI::registerPython() {
  ...
  class_<LennardJonesSoftcoreTI, bases<Potential> >(
      ...
      init<real, real, real, real, real, real, real, real, bool>())
      .def("addPid", pyAddPid);

  // class_< VerletListLennardJonesSoftcoreTI, bases< Interaction > >
  //  ("interaction_VerletListLennardJonesSoftcoreTI", init<
  ...
  //  .def("setPotentialAT",
  //  &VerletListHadressLennardJonesSoftcoreTI::setPotentialAT)
  //  .def("setPotentialCG",
  //  &VerletListHadressLennardJonesSoftcoreTI::setPotentialCG);
  //;
}
}
}
