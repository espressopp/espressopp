...
namespace espressopp {
  namespace interaction {
    ...
    computeEnergyAA(int atomtype) {
      std::cout << "Warning! At the moment computeEnergyAA(int atomtype) in VerletListHadressATATInteractionTemplate does not work." << std::endl;
      return 0.0;
    }
    ...
    computeEnergyCG(int atomtype) {
      std::cout << "Warning! At the moment computeEnergyCG(int atomtype) in VerletListHadressATATInteractionTemplate does not work." << std::endl;
      return 0.0;
    }
