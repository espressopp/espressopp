...
typedef class VerletListInteractionTemplate<TersoffPairTerm> VerletListTersoffPairTerm;
typedef class VerletListAdressInteractionTemplate<TersoffPairTerm, Tabulated>
    VerletListAdressTersoffPairTerm;
typedef class CellListAllPairsInteractionTemplate<TersoffPairTerm> CellListTersoffPairTerm;
typedef class FixedPairListInteractionTemplate<TersoffPairTerm> FixedPairListTersoffPairTerm;

//////////////////////////////////////////////////
// REGISTRATION WITH PYTHON
//////////////////////////////////////////////////
void TersoffPairTerm::registerPython() {
  using namespace espressopp::python;

  class_<TersoffPairTerm, bases<Potential> >("interaction_TersoffPairTerm",
  ...
  class_<VerletListTersoffPairTerm, bases<Interaction> >("interaction_VerletListTersoffPairTerm",
                                                         init<shared_ptr<VerletList> >())
      .def("getVerletList", &VerletListTersoffPairTerm::getVerletList)
      .def("setPotential", &VerletListTersoffPairTerm::setPotential,
           return_value_policy<reference_existing_object>())
      .def("getPotential", &VerletListTersoffPairTerm::getPotential,
           return_value_policy<reference_existing_object>());

  class_<CellListTersoffPairTerm, bases<Interaction> >("interaction_CellListTersoffPairTerm",
  ...
  class_<FixedPairListTersoffPairTerm, bases<Interaction> >(
      ...
      .def(
          init<shared_ptr<System>, shared_ptr<FixedPairListAdress>, shared_ptr<TersoffPairTerm> >())
