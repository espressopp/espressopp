          ...
          speedup(_speedup)
    {
        if (!potential)
        {
            throw std::invalid_argument(
                "No potential provided in FixedTripleListPIadressInteractionTemplate.");
        }
    }
    ...
    for (FixedTripleList::TripleList::Iterator it(*fixedtripleList); it.isValid(); ++it)
    {
        ...
        if ((w1 == 0.0) && (w2 == 0.0) && (w3 == 0.0))
        {
            ...
            else
            {
                ...
                if (it4 != fixedtupleList->end() && it5 != fixedtupleList->end() &&
                ...
                else
                {
                    ...
                    ss << "One of the VP particles not found in tuples. Particle 1 - ID: "
                       ...
                       << " Position: " << p2.position() << " Particle 3 - ID: " << p3.id()
                       << " Ghost: " << p3.ghost() << " Position: " << p3.position();
                    throw std::runtime_error(ss.str());
                }
            }
        }
...
template <typename _AngularPotential>
inline real FixedTripleListPIadressInteractionTemplate<_AngularPotential>::computeEnergyDeriv()
{
...
template <typename _AngularPotential>
inline real FixedTripleListPIadressInteractionTemplate<_AngularPotential>::computeEnergyAA()
{
...
template <typename _AngularPotential>
inline real FixedTripleListPIadressInteractionTemplate<_AngularPotential>::computeEnergyCG()
{
...
template <typename _AngularPotential>
inline real FixedTripleListPIadressInteractionTemplate<_AngularPotential>::getMaxCutoff()
{
