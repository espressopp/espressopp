...
public:
    FixedTripleListTypesInteractionTemplate(std::shared_ptr<System> system,
...
template <typename _Potential>
inline real FixedTripleListTypesInteractionTemplate<_Potential>::computeEnergy()
{
    ...
    for (FixedTripleList::TripleList::Iterator it(*fixedtripleList); it.isValid(); ++it)
    {
        ...
        LOG4ESPP_TRACE(theLogger, "id1=" << p1.id() << " id2=" << p2.id() << " id3=" << p3.id()
                                         << " potential energy=" << e);
    }
...
inline real FixedTripleListTypesInteractionTemplate<_AngularPotential>::computeEnergyDeriv()
{
    std::cout << "Warning! At the moment computeEnergyDeriv() in "
                 "FixedTripleListTypesInteractionTemplate does not work."
              << std::endl;
    return 0.0;
}

template <typename _Potential>
inline real FixedTripleListTypesInteractionTemplate<_Potential>::computeEnergyAA()
{
...
template <typename _Potential>
inline real FixedTripleListTypesInteractionTemplate<_Potential>::computeEnergyAA(int atomtype)
{
...
template <typename _Potential>
inline real FixedTripleListTypesInteractionTemplate<_Potential>::computeEnergyCG()
{
...
template <typename _Potential>
inline real FixedTripleListTypesInteractionTemplate<_Potential>::computeEnergyCG(int atomtype)
{
...
template <typename _Potential>
inline real FixedTripleListTypesInteractionTemplate<_Potential>::computeVirial()
{
...
template <typename _Potential>
inline real FixedTripleListTypesInteractionTemplate<_Potential>::getMaxCutoff()
{
    real cutoff = 0.0;
