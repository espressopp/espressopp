...
public:
    ...
    VSpherePair(real _epsilon, real _cutoff, real _shift) : epsilon(_epsilon)
    {
        setShift(_shift);
        setCutoff(_cutoff);
        preset();
    ...
    VSpherePair(real _epsilon, real _cutoff) : epsilon(_epsilon)
    {
        autoShift = false;
        setCutoff(_cutoff);
        preset();
...
{
    static boost::python::tuple getinitargs(VSpherePair const& pot)
    {
        real eps;
        real rc;
        real sh;
