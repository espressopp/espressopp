...
private:
    ...
    void spline(const real* x, const real* y, int n, real yp1, real ypn, real* y2);
...
inline real InterpolationCubic::splineInterpolation(real r, const real* fn, const real* fn2) const
{
