    ...
    : storage(_storage), globalTuples()
{
    ...
    con1 = storage->beforeSendParticles.connect(std::bind(&FixedLocalTupleList::beforeSendParticles,
                                                          this, std::placeholders::_1,
                                                          std::placeholders::_2));
    con2 = storage->afterRecvParticles.connect(std::bind(&FixedLocalTupleList::afterRecvParticles,
                                                         this, std::placeholders::_1,
                                                         std::placeholders::_2));
...
bool FixedLocalTupleList::addTuple(boost::python::list& tuple)
{
    bool returnVal = true;
...
void FixedLocalTupleList::afterRecvParticles(ParticleList& pl, InBuffer& buf)
{
