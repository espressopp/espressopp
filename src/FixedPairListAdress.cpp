...
FixedPairListAdress::FixedPairListAdress(std::shared_ptr<storage::Storage> _storage,
    ...
    : FixedPairList(_storage), fixedtupleList(_fixedtupleList)
{
    ...
    sigBeforeSendAT = fixedtupleList->beforeSendATParticles.connect(
        std::bind(&FixedPairListAdress::beforeSendATParticles, this, std::placeholders::_1,
                  std::placeholders::_2));

    sigAfterRecvAT = fixedtupleList->afterRecvATParticles.connect(
        std::bind(&FixedPairListAdress::afterRecvParticles, this, std::placeholders::_1,
                  std::placeholders::_2));
