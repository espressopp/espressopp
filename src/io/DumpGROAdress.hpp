...
// ESPP_CLASS
#ifndef _IO_DUMPGROADRESS_HPP
#define _IO_DUMPGROADRESS_HPP
...
namespace io
{
class DumpGROAdress : public ParticleAccess
{
public:
    DumpGROAdress(std::shared_ptr<System> system,
          ...
          append(_append)
    {
        ...
        // std::cout << "my rank: " << system->comm->rank() << ", number of particles: " <<
        // myParticleIDToTypeMap.size() << std::endl;
    ...
    ~DumpGROAdress()
    {
        std::cout << "DumpGROAdress destructor" << std::endl;
    }  // never called, right?
