...
DumpH5MD::~DumpH5MD() { clear_buffers(); }
...
void DumpH5MD::registerPython()
{
    ...
    class_<DumpH5MD>("io_DumpH5MD", init<std::shared_ptr<System>, bool>())
        ...
        .add_property("store_position", &DumpH5MD::get_store_position,
                      &DumpH5MD::set_store_position)
        ...
        .add_property("store_velocity", &DumpH5MD::get_store_velocity,
                      &DumpH5MD::set_store_velocity)
