...
void OrthorhombicBC::getMinimumImageVector(Real3D& dist, const Real3D& pos1,
...
/* Returns the minimum image vector between two positions */
void OrthorhombicBC::getMinimumImageVectorBox(Real3D& dist, const Real3D& pos1,
                                              const Real3D& pos2) const {
  dist = pos1;
  dist -= pos2;
...
/* Returns the minimum image vector between two positions */
void OrthorhombicBC::getMinimumImageVectorX(real dist[3], const real pos1[3],
