    ...
    : FixedQuadrupleList(_storage), fixedtupleList(_fixedtupleList)
{
    ...
    sigBeforeSendAT = fixedtupleList->beforeSendATParticles.connect(
        std::bind(&FixedQuadrupleListAdress::beforeSendATParticles, this, std::placeholders::_1,
                  std::placeholders::_2));

    sigAfterRecvAT = fixedtupleList->afterRecvATParticles.connect(
        std::bind(&FixedQuadrupleListAdress::afterRecvParticles, this, std::placeholders::_1,
                  std::placeholders::_2));
...
void FixedQuadrupleListAdress::registerPython()
{
    ...
    bool (FixedQuadrupleListAdress::*pyAdd)(longint pid1, longint pid2, longint pid3,
                                            longint pid4) = &FixedQuadrupleListAdress::add;
