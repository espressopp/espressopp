...
struct CellList : public esutil::ESPPContainer<std::vector<Cell*> >
{
};

struct NeighborCellList : public esutil::ESPPContainer<std::vector<NeighborCellInfo> >
{
};

struct LocalCellList : public esutil::ESPPContainer<std::vector<Cell> >
{
};
