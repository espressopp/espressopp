 ...
 * It is in order to minimize the cize of the cell, because otherwise user
 * should
 * be sure that
 * (r4-r1) < cell size
 * distance between first and the last particle should be smaller then the cell
 * size.
 * Now it is (r3-r1)
 *
 * That means that the structure of our quadruple in our local list will be the
 * next
