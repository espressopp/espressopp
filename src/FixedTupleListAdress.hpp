...
public:
    ...
    boost::signals2::signal<void(std::vector<longint>&, class OutBuffer&)> beforeSendATParticles;
    boost::signals2::signal<void(ParticleList&, class InBuffer&)> afterRecvATParticles;
