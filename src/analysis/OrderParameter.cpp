...
dcomplex OrderParameter::SphHarm(int l, int m, Real3D r)
{
    ...
    // throw std::runtime_error("OrderParameter::SphHarm is broken (used for coupled cluster
    // analysis only"); return dcomplex(0);
}
...
void OrderParameter::registerPython()
{
    ...
    class_<OrderParameter, bases<AnalysisBase> >(
        ...
        init<std::shared_ptr<System>, real, int, bool, bool, real, real>())
