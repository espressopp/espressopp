...
int ConfigurationsExt::getCapacity() { return maxConfigs; }

int ConfigurationsExt::getSize() { return configurationsExt.size(); }

ConfigurationExtList ConfigurationsExt::all() { return configurationsExt; }
...
void ConfigurationsExt::registerPython()
{
    ...
    class_<ConfigurationsExt>("analysis_ConfigurationsExt", init<std::shared_ptr<System> >())
