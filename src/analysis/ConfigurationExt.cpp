...
// however, passing reference is dangerous, since the original object might not survive until the
// end of this class how should I use const here?
...
void ConfigurationExtIterator::incrementIterator() { it++; }
...
void ConfigurationExt::registerPython()
{
    ...
    class_<ConfigurationExt>("analysis_ConfigurationExt", no_init)
