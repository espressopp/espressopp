...
int Velocities::getCapacity() { return maxConfigs; }

int Velocities::getSize() { return configurations.size(); }

ConfigurationList Velocities::all() { return configurations; }
...
ConfigurationPtr Velocities::back() { return configurations.back(); }
...
void Velocities::registerPython()
{
    ...
    class_<Velocities>("analysis_Velocities", init<std::shared_ptr<System> >())
