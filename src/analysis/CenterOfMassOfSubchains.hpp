...
// ESPP_CLASS
#ifndef _ANALYSIS_CENTEROFMASSOFSUBCHAINS_HPP
#define _ANALYSIS_CENTEROFMASSOFSUBCHAINS_HPP
...
namespace espressopp {
  namespace analysis {
    ...
    */
    class CenterOfMassOfSubchains : public ConfigsParticleDecomp {

    public:
      
      CenterOfMassOfSubchains(shared_ptr<System> system, int _chainlength): ConfigsParticleDecomp (system, _chainlength){
