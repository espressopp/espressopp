 ...
 * */
class AnalysisBase : public ParticleAccess
{  // SystemAccess {
public:
...
{
public:
    AnalysisBaseTemplate(std::shared_ptr<System> system)
        : AnalysisBase(system){
              // this->reset();
          };
...
template <class ResultType>
inline void AnalysisBaseTemplate<ResultType>::performMeasurement()
{
...
template <class ResultType>
inline void AnalysisBaseTemplate<ResultType>::reset()
{
    nMeasurements = 0;
    resetAverage();
};
...
template <class ResultType>
inline int AnalysisBaseTemplate<ResultType>::getNumberOfMeasurements()
{
