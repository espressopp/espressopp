...
namespace analysis
{
// It will calculate the molecular local virial pressure in 'n' layers along X axis, works only for
// AdResS simulations.
...
void XPressure::registerPython()
{
    ...
    class_<XPressure, bases<Observable> >("analysis_XPressure", init<std::shared_ptr<System> >())
