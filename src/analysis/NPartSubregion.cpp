...
void NPartSubregion::setCenter(real x, real y, real z) { center = Real3D(x, y, z); }

void NPartSubregion::registerPython()
{
    using namespace espressopp::python;
    void (NPartSubregion::*pySetCenter)(real x, real y, real z) = &NPartSubregion::setCenter;
    class_<NPartSubregion, bases<Observable> >("analysis_NPartSubregion",
                                               init<std::shared_ptr<System>, int, real, int>())
