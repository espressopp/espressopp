...
class TestLangevinThermostat(unittest.TestCase):
    ...
    def test_normal(self):
        ...
        self.system.vectorization = espressopp.vec.Vectorization(self.system)
        self.system.storage = espressopp.vec.storage.DomainDecomposition(self.system, nodeGrid, cellGrid)
        ...
        vl = espressopp.vec.VerletList(self.system, cutoff=1.5)

        # integrator
        integrator = espressopp.vec.integrator.VelocityVerlet(self.system)
        integrator.dt = 0.01

        # Langevin Thermostat
        langevin = espressopp.vec.integrator.LangevinThermostat(self.system)
        langevin.gamma = 1.0
