...
class TestMTSAdResS(unittest.TestCase):
    ...
    def test_AT_CG_templates_FAdResS(self):
        ...
        # run checks
        self.assertAlmostEqual(after[0], 9.364194, places=3)
        self.assertEqual(before[1], after[1])
        self.assertEqual(before[2], after[2])
        self.assertAlmostEqual(after[3], 7.260933, places=3)
        self.assertEqual(before[4], after[4])
        self.assertEqual(before[5], after[5])
        self.assertAlmostEqual(after[6], 4.912661, places=3)
        self.assertEqual(before[7], after[7])
        self.assertEqual(before[8], after[8])
        self.assertAlmostEqual(after[9], 0.700571, places=3)
        self.assertEqual(before[10], after[10])
        self.assertEqual(before[11], after[11])
        self.assertAlmostEqual(after[12], 5.261640, places=3)
        self.assertEqual(before[13], after[13])
        self.assertEqual(before[14], after[14])
        self.assertAlmostEqual(energy_before, 199.996600, places=3)
        self.assertAlmostEqual(energy_after, 1.382440, places=3)
