...
class TestRattle(unittest.TestCase):
    ...
    def test_rattle(self):
        ...
        rattle = espressopp.integrator.Rattle(
            self.system, maxit=1000, tol=1e-6, rptol=1e-6)
