...
system.storage.addParticles(
    [[1, 0, espressopp.Real3D(5, 5, 5)]], 'id', 'type', 'pos')
system.storage.addParticles(
    [[2, 0, espressopp.Real3D(5, 6, 5)]], 'id', 'type', 'pos')
system.storage.addParticles(
    [[3, 1, espressopp.Real3D(6, 5, 5)]], 'id', 'type', 'pos')
system.storage.addParticles(
    [[4, 1, espressopp.Real3D(6, 6, 5)]], 'id', 'type', 'pos')
