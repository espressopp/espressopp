...
class TestCaseLangevinThermostatOnRadius(unittest.TestCase):
    ...
    def test_on_radius(self):
        ...
        # run checks (first particle excluded, hence it's radius should not
        # change. The other should have changed, however, as they feel the
        # thermostat on radius)
