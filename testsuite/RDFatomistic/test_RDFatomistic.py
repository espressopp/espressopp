...
class TestThermoIntegration(unittest.TestCase):
    ...
    def test_span_true(self):
        # set up rdfs
        rdf_span = espressopp.analysis.RDFatomistic(system = system, type1 = 0, type2 = 0, spanbased = True, span = 1.0)
    ...
    def test_span_false(self):
        # set up rdfs
        rdf_nospan = espressopp.analysis.RDFatomistic(system = system, type1 = 0, type2 = 0, spanbased = False)
