...
# this file uses a system containing only two particles, for testing
# input/output tools with minimum computational time
...
class TestPythonTools(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.system.storage.addParticles(
            particle_list, 'id', 'type', 'q', 'pos', 'mass')
    ...
    def test_psf_read_write(self):
        ...
        espressopp.tools.psfwrite(
            ...
            molsize=0,
            typenames=typenames)
        pid, segname, resindex, resname, atomname, atomtype, mass, charge = espressopp.tools.psfread(
            filename)
    ...
    def test_pdb_read_write(self):
        ...
        espressopp.tools.pdbwrite(
            ...
            append=False,
            typenames=typenames)
        index, atomname, locator, resname, resid, resseq, x, y, z, alpha, beta, segid, element = espressopp.tools.pdbread(
            filename, natoms=2, header=2)
    ...
    def test_read_simple_system(self):
        ...
        nparticles = 2
        mass, charge, index, name, ptype = espressopp.tools.readSimpleSystem(
            filename, nparticles, header=1)
