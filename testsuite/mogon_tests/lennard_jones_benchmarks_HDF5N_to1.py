...
base_path_files = '/gpfs/fs2/project/zdvresearch/padua/lennard_jones_tests/'
...
if hdf5_file is True:
  ...
  start_io_time_write = time.clock()
  #espressopp.tools.writexyz(filename, system, velocities = True, unfolded = False)
  espressopp.tools.writexyz(base_filename, system, velocities = True, unfolded = False)
...
result_file = 'result_cores_%i_mode_%s.dat' % (NCPUs, mode)
...
os.system("sync")
#cmd = "rm -f /gpfs/fs2/project/zdvresearch/padua/lennard_jones_tests/*.h5"
#os.system(cmd)
