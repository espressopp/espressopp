...
# define a force capped Lennard-Jones interaction that uses a verlet list 
interaction = espresso.interaction.VerletListLennardJonesCapped(verletlist)
# use a force capped Lennard-Jones potential between 2 particles of type 0 
...
for step in range(warmup_nloops):
  ...
  # decrease force capping radius
  potential.epsilon += epsilon_delta
  # print status info
  espresso.tools.info(system, integrator)  
