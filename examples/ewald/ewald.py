...
# (Coulomb interaction) using the Ewald summation method.                   #
#                                                                           #
#############################################################################
...
#
#  File 'ewald_result.dat' contains results which were obtained by Markus Deserno for exactly
...
vl = espressopp.VerletList(system, rspacecutoff)
