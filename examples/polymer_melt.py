...
bonds, angles, x, y, z, Lx, Ly, Lz = espresso.tools.convert.lammps.read('polymer_melt.start')
...
potLJ   = interLJ.setPotential(type1=0, type2=0, potential=espresso.interaction.LennardJones(epsilon=1.0, sigma=1.0, cutoff=rc, shift=0))
